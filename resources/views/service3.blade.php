...
<body>
        ...
        <ul class="nav nav-underline navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
              ...
              <li><a class="dropdown-item active" href="/service3">Service 3</a></li>
              <li>
  ...
  <svg class="bd-placeholder-img bd-placeholder-img-lg img-fluid" width="100%" height="250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Responsive image" preserveAspectRatio="xMidYMid slice" focusable="false">
    ...
    <rect width="100%" height="100%" fill="#0d6efd"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em">This is Service 3</text>
  </svg>
</body>
